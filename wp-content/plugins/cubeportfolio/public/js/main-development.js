 ...
 *
 * version: 3.2.0 (25 September, 2015)
 * require: jQuery v1.7+
 *
...
(function($, window, document, undefined) {
    ...
    function FullWidthForce(parent, forceWidthBlock) {
        var t = this;
    ...
    FullWidthForce.prototype.destroy = function() {
        var t = this;
    };

    CubePortfolio.Plugins.FullWidthForce = function(parent) {
        return new FullWidthForce(parent);
    };
})(jQuery, window, document);
